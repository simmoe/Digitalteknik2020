...
function h5pmods_alter_scripts(&$scripts, $libraries, $embed_type) {
  if (isset($libraries['H5P.InteractiveVideo'])) {
    $scripts[] = (object) array(
      ...
      'path' => 'http://interaktivbog.it.nextkbh.dk/wp-content/plugins/h5pmods/videoscript.js',
...
function h5pmods_alter_styles(&$styles, $libraries, $embed_type) {
  $styles[] = (object) array(
    // Path can be relative to wp-content/uploads/h5p or absolute.
    'path' => 'http://interaktivbog.it.nextkbh.dk/wp-content/plugins/h5pmods/styles.css',
